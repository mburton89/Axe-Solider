...
namespace MenteBacata.ScivoloCharacterControllerDemo
{
    public class SimpleCharacterController : MonoBehaviour
    {
        ...
        private const float timeBeforeUngrounded = 0.1f; // Allowed time before the character is set to ungrounded from the last time he was safely grounded.
        private float verticalSpeed = 0f; // Speed along the character local up direction.
        private float nextUngroundedTime = -1f; // Time after which the character should be considered ungrounded.
